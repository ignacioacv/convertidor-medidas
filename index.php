...
<body>
    ...
    <form class="g-3 needs-validation" novalidate>
        ...
        <label class="p-2" for="tipo_medida"><b>Tipo de medida:</b></label>
            <select class="form-select mt-2" id="tipo_medida" onchange="cambiarUnidades()" aria-label="Default select example" required>
        ...
        <div class="main-inputs mt-4">
            <input class="form-control mt-2" type="number" required>   
            <div class="invalid-feedback">
            Porfavor, ingresa la cantidad a convertir
            </div>
            
            <label class="p-1 mt-2" for="unidad_origen"><b>De:</b></label>
            <select class="form-select mt-1" id="unidad_origen" required>
            </select>   
           
            <label class="p-1 mt-2  " for="unidad_destino"><b>A:</b></label>
            <select class="form-select mt-1" id="unidad_destino" required></br>
            </select>
            
            <div class="resultado p-1 mt-2 text-danger text-center"><span>Resultado de la Conversion</span></div>       
